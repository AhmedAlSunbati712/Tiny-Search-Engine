# Crawler - Assumptions & Implementation

## Assumptions
The only assumption that is made is that the user already has a directory with the name pageDirectory already created. If that directory doesn't exist, the program won't run.
